...
export const products: Product[] = [
  ...
  {
    id: 'durga-crystal-lamp',
    name: 'Goddess Durga 3D Crystal Lamp',
    slug: 'durga-crystal-lamp',
    description: 'Embrace the divine power of Goddess Durga with this majestic 3D crystal lamp. The fierce and protective form of Maa Durga riding her lion is beautifully captured in premium crystal. Ideal for Navratri celebrations and invoking strength.',
    shortDescription: 'Powerful Goddess Durga crystal lamp for protection',
    price: 2799,
    compareAtPrice: 3899,
    images: {
      day: heroLamp,
    ...
    features: [
      ...
      'Multi-color LED base included',
      'USB powered - safe & energy efficient',
      'Perfect for Navratri celebrations',
    ...
    rating: 4.8,
    reviewCount: 112,
    tags: ['navratri', 'durga', 'deity', 'protection', 'power'],
  },
  {
    id: 'saraswati-crystal-lamp',
    name: 'Goddess Saraswati 3D Crystal Lamp',
    slug: 'saraswati-crystal-lamp',
    description: 'Invoke wisdom and knowledge with our beautiful Goddess Saraswati 3D Crystal Lamp. The serene form of Maa Saraswati with her veena is captured in stunning detail. Perfect for study rooms, music spaces, and academic settings.',
    shortDescription: 'Divine Goddess Saraswati for wisdom and learning',
    price: 2499,
    compareAtPrice: 3499,
    images: {
      day: krishnaDay,
  ...
  {
    id: 'solar-system-crystal',
    name: 'Solar System Crystal Ball',
    slug: 'solar-system-crystal',
    description: 'Explore the wonders of our solar system with this educational and beautiful crystal ball. Features detailed engravings of all planets orbiting the sun. A perfect gift for space enthusiasts, students, and anyone who marvels at the cosmos.',
    shortDescription: 'Educational solar system design in premium crystal',
    price: 2299,
    compareAtPrice: 2999,
    images: {
      day: galaxyDay,
    ...
    specifications: {
      size: '80mm diameter sphere',
      weight: '450g',
      material: 'Optical Crystal Glass',
      power: 'USB 5V DC',
      ledType: 'RGB Multi-color',
    },
    inStock: true,
    rating: 4.8,
    reviewCount: 156,
    tags: ['galaxy', 'solar-system', 'educational', 'gift'],
  },
  {
    id: 'moon-crystal-lamp',
    name: 'Full Moon Crystal Lamp',
    slug: 'moon-crystal-lamp',
    description: 'Capture the serene beauty of a full moon with this enchanting crystal lamp. The detailed lunar surface is laser-engraved to perfection, creating a calming ambiance in any space. Ideal for bedrooms, meditation corners, and romantic settings.',
    shortDescription: 'Realistic full moon engraved in crystal with LED base',
    price: 1799,
    compareAtPrice: 2499,
    images: {
      day: galaxyDay,
    ...
    features: [
      'High-clarity optical crystal',
      'Realistic lunar surface detail',
      'Wooden LED base included',
      'USB powered',
    ...
    rating: 4.6,
    reviewCount: 134,
    tags: ['galaxy', 'moon', 'night-light', 'calming'],
  },
  {
    id: 'wooden-led-base',
  ...
  {
    id: 'premium-acrylic-base',
    name: 'Premium Acrylic LED Base',
    slug: 'premium-acrylic-base',
    description: 'Modern and sleek acrylic LED base for your crystal lamps. Features a transparent design that enhances the crystal\'s brilliance. Includes touch controls for easy color changing and brightness adjustment.',
    shortDescription: 'Sleek acrylic base with touch controls and RGB LEDs',
    price: 599,
    compareAtPrice: 899,
    images: {
      day: woodenBaseDay,
    ...
    features: [
      ...
      'RGB multi-color LEDs',
      'USB powered',
      'Brightness adjustment',
      'Compatible with all crystals',
    ],
    specifications: {
      size: '80mm x 80mm x 20mm',
      weight: '120g',
      material: 'Premium Acrylic',
      power: 'USB 5V DC',
      ledType: 'RGB with touch control',
    },
    inStock: true,
    rating: 4.5,
    reviewCount: 67,
    tags: ['accessory', 'base', 'modern', 'acrylic'],
  },
  {
    id: 'rotating-led-base',
    name: 'Rotating LED Display Base',
    slug: 'rotating-led-base',
    description: 'Take your crystal display to the next level with our rotating LED base. Features a smooth 360-degree rotation that showcases your crystal from every angle. Perfect for display cabinets, shop windows, and special occasions.',
    shortDescription: '360-degree rotating base with multi-color LEDs',
    price: 899,
    compareAtPrice: 1299,
    images: {
      day: woodenBaseDay,
    ...
    specifications: {
      size: '100mm diameter x 30mm',
      weight: '220g',
      material: 'ABS Plastic with Mirror top',
      power: 'USB 5V DC',
      ledType: 'RGB with rotation',
    },
    inStock: true,
    rating: 4.7,
    reviewCount: 45,
    tags: ['accessory', 'base', 'rotating', 'display'],
  },
];
...
export const reviews: Review[] = [
  ...
  {
    id: 'review-7',
    productId: 'hanuman-crystal-lamp',
    author: 'Arun P.',
    rating: 5,
    title: 'Strength and Devotion',
    content: 'Placed this in my gym and it gives me motivation every day. The craftsmanship is impeccable. Jai Hanuman!',
    date: '2024-01-20',
    verified: true,
  },
  {
    id: 'review-8',
    productId: 'wooden-led-base',
    author: 'Kavitha M.',
    rating: 4,
    title: 'Great Quality Base',
    content: 'The wooden base is well-made and the LED colors are vibrant. Remote works well. Would recommend getting one as a spare.',
    date: '2024-01-14',
    verified: true,
  },
];
